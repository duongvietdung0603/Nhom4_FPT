...
public class LichChieuService {
    ...
    public List<LichChieu> findByMoviceId(long idMovice) {
        return lichChieuRepository.findByMoviceId(idMovice);
    }

    public List<LichChieu> findByMoviceIdAndNgayChieuAndStatus(long idMovice, Date idNgay, Integer suat) {
        return lichChieuRepository.findByMoviceIdAndNgayChieuAndStatus(idMovice, idNgay, suat);
    }
}
